...
{
    public partial class DrawDialog : Form, MessageHandler
    {
        ...
        private void DrawDialog_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void DrawDialog_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
